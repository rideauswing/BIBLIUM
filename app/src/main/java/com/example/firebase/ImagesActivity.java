    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.item1:
                ...
                if(currentUser.getUid().equals("8oYBfuuhHNdjioWKb3KYvKcmtK12"))
                    startActivity(new Intent(ImagesActivity.this, MainActivity.class));
                else{
                    Toast.makeText(ImagesActivity.this, "You don't have enough rights to access this data", Toast.LENGTH_SHORT).show();
            }
        }
